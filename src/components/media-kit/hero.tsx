          ...
          <div className="order-2 lg:order-1 lg:col-span-7">
            ...
            <div className="mt-9 grid gap-6 sm:grid-cols-[auto_1fr] sm:gap-10 items-start">
              <div>
                ...
                <div className="mt-1 text-sm text-muted-foreground">Influenciador Digital</div>
              ...
              <p className="max-w-md text-base text-muted-foreground leading-relaxed sm:border-l sm:border-border sm:pl-8">
                Conectando marcas a uma audiência engajada em negócios, IA, produtividade e
                liberdade financeira — com narrativa própria e execução consistente.
              </p>
            </div>
