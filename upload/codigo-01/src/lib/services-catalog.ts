import videoCover from "@/assets/servico-video-dedicado.png.asset.json";
import mencoesCover from "@/assets/servico-mencoes-patrocinadas.png.asset.json";
import storiesCover from "@/assets/servico-serie-stories.png.asset.json";
import comboCover from "@/assets/servico-combo-completo.png.asset.json";
import roteiroCover from "@/assets/servico-roteiro-estrategico.webp.asset.json";
import edicaoCover from "@/assets/servico-edicao-viral.webp.asset.json";
import packCover from "@/assets/servico-pack-criativos.webp.asset.json";
import auditoriaCover from "@/assets/servico-auditoria-perfil.webp.asset.json";
import ebookBriefingCover from "@/assets/ebook-guia-briefing-viral.webp.asset.json";
import ebookGanchosCover from "@/assets/ebook-30-ganchos-reels.webp.asset.json";
import ebookEdicaoCover from "@/assets/ebook-manual-edicao-premium.webp.asset.json";
import ebookStorytellingCover from "@/assets/ebook-storytelling-magnetico.jpg.asset.json";
import ebookIaCover from "@/assets/ebook-ia-criadores.jpg.asset.json";
import ebookNetworkingCover from "@/assets/ebook-networking-marcas.jpg.asset.json";
import ebookPromptsCover from "@/assets/ebook-pack-prompts.jpg.asset.json";
import ebookImagensCover from "@/assets/ebook-pack-imagens.jpg.asset.json";
import pdfGuiaBriefing from "@/assets/guia-briefing-viral.pdf.asset.json";
import pdf30Ganchos from "@/assets/30-ganchos-reels.pdf.asset.json";
import pdfManualEdicao from "@/assets/manual-edicao-premium.pdf.asset.json";
import pdfRoteiro from "@/assets/roteiro-estrategico.pdf.asset.json";
import pdfEdicaoViral from "@/assets/edicao-viral.pdf.asset.json";
import pdfPackCriativos from "@/assets/pack-criativos.pdf.asset.json";
import pdfStorytelling from "@/assets/storytelling-magnetico.pdf.asset.json";
import pdfIa from "@/assets/ia-para-criadores.pdf.asset.json";
import pdfNetworking from "@/assets/networking-com-marcas.pdf.asset.json";
import pdfPrompts from "@/assets/pack-prompts-premium.pdf.asset.json";
...
const campaignQuestions: QuestionField[] = [
  ...
  {
    name: "product",
    label: "Produto, serviço ou campanha",
    type: "textarea",
    required: true,
    placeholder: "Descreva o que será divulgado",
  },
  {
    name: "audience",
    label: "Público-alvo",
  ...
  },
  {
    ...
    type: "text",
    required: true,
    placeholder: "Ex: Premium, direto, aspiracional",
  },
];
...
export const SERVICES: Record<ServiceSlug, Service> = {
    ...
    questions: [
      {
        ...
        type: "text",
        required: true,
        placeholder: "Ex: estética, finanças, moda, saúde",
      },
      {
        name: "goal",
        label: "Qual o objetivo dos roteiros?",
        type: "textarea",
        required: true,
        placeholder: "Ex: gerar autoridade, vender, captar leads",
      },
      {
        name: "audience",
        label: "Público-alvo",
      ...
      {
        name: "references",
        label: "Referências ou concorrentes",
        type: "textarea",
        placeholder: "Perfis, criadores ou estilos que você admira",
      },
    ],
    upsell: "edicao-viral",
    scarcityLabel: "Oferta de entrada com disponibilidade reduzida nesta semana.",
    pdfUrl: pdfRoteiro.url,
  },
  "edicao-viral": {
    slug: "edicao-viral",
    kind: "service",
    ...
    questions: [
      {
        name: "video_type",
        label: "Tipo de vídeo enviado",
        type: "text",
        required: true,
        placeholder: "Ex: depoimento, tutorial, venda direta",
      },
      {
        name: "goal",
        label: "Objetivo da edição",
        type: "text",
        required: true,
        placeholder: "Ex: mais retenção, mais cliques, mais autoridade",
      },
      {
        name: "references",
        label: "Referências visuais ou sonoras",
        type: "textarea",
        placeholder: "Se tiver links ou exemplos, envie aqui",
      },
      {
        name: "deadline",
  ...
  "pack-criativos": {
    ...
    questions: [
      {
        name: "brand_style",
        label: "Cores e estilo da sua marca",
        type: "text",
        required: true,
        placeholder: "Ex: preto, dourado, sofisticado, minimalista",
      },
      {
        name: "art_type",
      ...
      {
        name: "messages",
        label: "Textos ou mensagens-chave",
        type: "textarea",
        placeholder: "Ofertas, slogans ou dores que devem aparecer",
      },
    ],
    scarcityLabel: "Pacote com valor especial para esta semana.",
    pdfUrl: pdfPackCriativos.url,
  },
  "auditoria-de-perfil": {
    ...
    questions: [
      {
        name: "profile_link",
        label: "Link do perfil Instagram ou TikTok",
        type: "text",
        required: true,
      ...
      {
        name: "main_goal",
        label: "Principal meta com o perfil",
        type: "text",
        required: true,
        placeholder: "Ex: vender mais, crescer seguidores, reposicionar",
      },
      {
        name: "biggest_block",
        label: "Qual é hoje o maior bloqueio do perfil?",
        type: "textarea",
        placeholder: "Conte o que sente que trava seus resultados",
      },
    ],
  ...
  "ebook-30-ganchos-reels": {
    ...
    questions: [
      {
        name: "instagram",
        label: "Seu @ do Instagram (opcional)",
        type: "text",
        placeholder: "Para personalizarmos comunicações futuras",
      },
    ],
    scarcityLabel: "Oferta especial de entrada disponível hoje.",
    pdfUrl: pdf30Ganchos.url,
  },
  "ebook-manual-edicao-premium": {
  ...
  "ebook-storytelling-magnetico": {
    ...
    tag: "E-book Premium",
    cover: ebookStorytellingCover.url,
    priceCents: 1990,
    priceLabel: "R$ 19,90",
    description:
  ...
  "ebook-networking-marcas": {
    ...
    tag: "Lead Magnet",
    cover: ebookNetworkingCover.url,
    priceCents: 0,
    priceLabel: "Gratuito",
    description:
...
/**
 * Serviços com produção limitada: exigem verificação de disponibilidade e
 * passagem pela fila de espera antes do checkout.
 */
