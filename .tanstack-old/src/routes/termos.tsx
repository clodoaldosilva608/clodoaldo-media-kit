...
export const Route = createFileRoute("/termos")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Termos de uso e condições de contratação dos serviços de Clodoaldo Silva." },
      { property: "og:title", content: "Termos de Serviço | Clodoaldo Silva" },
        ...
        <div className="prose-content mt-10 space-y-8 text-base text-foreground/90 leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              plataforma Stripe. O serviço é considerado contratado após a
