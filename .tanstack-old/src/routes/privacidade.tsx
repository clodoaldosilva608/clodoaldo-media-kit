...
export const Route = createFileRoute("/privacidade")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Como coletamos, usamos e protegemos seus dados pessoais conforme a LGPD." },
      { property: "og:title", content: "Política de Privacidade | Clodoaldo Silva" },
        ...
        <div className="mt-10 space-y-8 text-base text-foreground/90 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                ...
                Stripe. Não armazenamos números de cartão.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              Stripe (pagamentos), Lovable Cloud (hospedagem e banco de dados) e
